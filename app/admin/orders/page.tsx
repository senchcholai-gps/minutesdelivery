                ...
                filteredOrders.map((order) => (
                  <tr key={order.order_id} className="hover:bg-gray-50/50 transition-colors group">
                    <td className="px-6 py-4">
                      <p className="font-bold text-gray-900 leading-tight">#{order.order_id}</p>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-2">
                        ...
                        <Select 
                          ...
                          onValueChange={(val) => updatePaymentStatus(order.order_id, val)}
                    ...
                    <td className="px-6 py-4 text-right">
                      ...
                      <Button
                        ...
                        title="Download PDF"
                        disabled={downloadingPdfId === order.order_id}
                        onClick={() => downloadPdf(order.order_id)}
                      >
                        {downloadingPdfId === order.order_id
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-2xl rounded-2xl border-none shadow-2xl">
                          <DialogHeader>
                            <DialogTitle className="text-2xl font-bold tracking-tight">Order Details #{order.order_id}</DialogTitle>
